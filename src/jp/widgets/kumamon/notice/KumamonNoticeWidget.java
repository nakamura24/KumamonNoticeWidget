			...
			if (ACTION_FILLIN.equals(intent.getAction())) {
				...
				if (extras != null) {
					...
					Intent dialogIntent = new Intent(context,
							NoticeWidgetEventDialog.class);
					dialogIntent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID,
							appWidgetId);
					dialogIntent.putExtra(EXTRA_ITEM,
							position);
	...
	public static void updateAppWidget(Context context, int appWidgetId) {
		...
		try {
			...
			RemoteViews remoteViews = new RemoteViews(context.getPackageName(),
					R.layout.widget_notice);
			remoteViews.setRemoteAdapter(R.id.notice_title_StackView, viewIntent);

			// The empty view is displayed when the collection has no items. It
			// should be a sibling
			// of the collection view.
			remoteViews.setEmptyView(R.id.notice_title_StackView, R.id.notice_empty_RelativeLayout);
			...
			remoteViews.setPendingIntentTemplate(R.id.notice_title_StackView,
					fillInPendingIntent);
			...
			remoteViews.setOnClickPendingIntent(R.id.notice_icon_ImageView,
					pendingIntent);

			AppWidgetManager appWidgetManager = AppWidgetManager
					.getInstance(context);
			appWidgetManager.notifyAppWidgetViewDataChanged(appWidgetId,
					R.id.notice_title_StackView);
